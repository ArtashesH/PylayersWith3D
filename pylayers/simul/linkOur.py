...
class DLink(Link):
    ...
    def _show3(self,rays=True, lay= True, ant= True, newfig= False, **kwargs):
        ...
        """
        print("Scond time crash 7777777777777777777777 \n")      
        if not newfig:
        ...
        xForD1 = [2.5,2.5,2.5,2.5]
        yForD1 = [2.5,2.5,2.5,2.5]
        zForD1 = [1.2,1.2,1.2,1.2]
		
        xForD2 = [4.0,5.0,0,0]
        yForD2 = [2.5,2.5,2.5,2.5]
        zForD2 = [3.0,0.6,0.6,2.1]
		
		
        xForD3 = [5.0,7.5,2.5,2.5]
        yForD3 = [2.5,2.5,2.5,2.5]
        zForD3 = [1.8,0.0,0.0,3.0]
		
		
        xForD4 = [6.5,10,5.0,5.0]
        yForD4 = [2.5,2.5,2.5,2.5]
        zForD4 = [0.0,0.6,0.6,2.1]
		
        xForD5 = [7.5,7.5,7.5,7.5]
        yForD5 = [2.5,2.5,2.5,2.5]
        zForD5 = [1.2,1.2,1.2,1.2]
		
		#DL.R[3]['pt'][0][2]
		
        mlab.plot3d([xForD1[0],xForD2[0]],[yForD1[0],yForD2[0]],[zForD1[0],zForD2[0]],color=(1,0,0),tube_radius=.015)
        mlab.plot3d([xForD1[1],xForD2[1]],[yForD1[1],yForD2[1]],[zForD1[1],zForD2[1]],color=(1,0,0),tube_radius=.015)
