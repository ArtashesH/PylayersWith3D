...
class Coverage(PyLayers):
    ...
    def __init__(self,_fileini='E:/upworkProjs/FloorPlanAnalyzing/pylayers-master/data/ini/coverage.ini'):
        """ object constructor
        ...
        print("Artashes fileName ")
        print(filename)
        print("Ends with ")
        print(filename.endswith('lay'))
     ...
     #       print(self.boundary[2])
     #       print(self.boundary[3])
     #       exit()
            self.dap = {}
            for k in self.apopt:
